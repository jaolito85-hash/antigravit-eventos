    ...
    try:
        ...
        if fichas:
            ...
            system += (
                ...
                "Praça de Alimentação, e para produto da loja e a ficha da loja oficial.\n"
        ...
        if historico:
            system += (
                ...
                "depois de uma pergunta do Tuca é a resposta a ela. Referência curta "
                "aponta para o assunto MAIS RECENTE da conversa, nunca para um anterior "
                "já respondido: depois de seda, \"valeu\" e depois bebidas, \"sabe onde "
                "compra?\" é sobre bebidas. \"[mandou a arte: ...]\" ou \"[mandou a "
                "imagem com a resposta]\" numa fala do Tuca quer dizer que ele respondeu "
                "a pergunta anterior com a arte (cardápio, preço, line-up); a pergunta "
                "seguinte sobre o mesmo assunto casa com a MESMA ficha. O lugar onde "
...
Generate ONE creative, unique reply (do NOT copy the examples). Reply in the SAME LANGUAGE as the participant's message:'''
        ...
        if historico:
            ...
            user_msg += (
                ...
                f"<history>\n{historico_seguro}\n</history>\n"
                "A short follow-up (\"quanto custa?\", \"onde compra?\") is about the MOST "
                "RECENT subject of the conversation, the one in the last exchange, never "
                "about an earlier subject that was already answered and left behind. The "
                "OFFICIAL ANSWER or GUIDE in this prompt is about that current subject: "
                "answer from it. Facts such as a place, a price or a time come ONLY from "
                "the official material of THIS reply, never copied from the history. Never "
                "ask which item they mean when the conversation already says it. If they "
                "repeat a question you already answered, answer it again, shorter, without "
                "saying you already answered."
            )
        user_msg += (
